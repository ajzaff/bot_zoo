...
// Flip returns the square mirrored acoss the rank and file axes (e.g. c1 <=> f8).
// i must be valid.
func (i Square) Flip() Square {
	return 63 - i
}

// MirrorLateral returns the square mirrored acoss the file axis (e.g. c3 <=> f3).
// Used for dataset augmentation. i must be valid.
func (i Square) MirrorLateral() Square {
	return Square(8*i.Rank() + 7 - i.File())
}
